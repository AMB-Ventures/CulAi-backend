...
employeeSchema.statics = {
  ...
  updateAll: async function (query, updateData) {
    let result = await this.updateMany({}, { $set: updateData });
    return result;
  },
  ...
  getShifts: async function (query) {
    let result = await this.find(query, {
      employeeId: 1,
      emailId: 1,
      adminId: 1,
