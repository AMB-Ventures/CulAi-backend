    ...
    try {
        if (req.body !== undefined && req.body !== null && req.body.data) {
            ...
            if (data) {
                ...
                let imageResp = null;
                if (req.file) {
                    imageResp = await s3ImageUpload(req.file, `menuimage/${req.body.vendorName}`);
                ...
                if (imageResp) vendorObject.vendorLogo = imageResp.path.Key;
...
exports.updateVendor = async (req, res, next) => {
    ...
    if (vendorData) {
        if (req.body !== null && req.body !== undefined) {
            ...
            if (imageResp) newVendor.vendorLogo = imageResp.path.Key;
